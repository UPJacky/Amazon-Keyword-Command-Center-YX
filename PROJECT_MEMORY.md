...
- Pages 发布源审计确认公开关键脚本仍与远端 `main` 根目录旧版本一致；本地 live allowlist 构建 49 文件通过，`master` 新版本尚未部署到当前 Pages Source。详见 `docs/acceptance/github-pages-publish-source-audit-20260915.md`。
