...
class ProductionRuntimeTests(unittest.TestCase):
    ...
    def test_real_csv_pipeline_bundle_and_completion_order(self):
        ...
        self.assertEqual({"rank-benchmark.json", "negative-keywords.json", "listing-diagnostics.json", "optimization-plan.json"}, set(bundle["modules"]))
        self.assertNotIn("competitors.json", bundle["modules"])
    ...
    def test_existing_competitor_artifact_and_actual_marketplace_are_bundled(self):
        ...
        self.assertEqual("partial", bundle["module_states"]["listing-diagnostics.json"]["status"])
